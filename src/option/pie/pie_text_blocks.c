...
#define RE_DATE "\\b([1290]{2}[0-9]{2}-*[01][0-9]-*[0123][0-9]|[1290]{2}[0-9]{2}[0123][0-9]|[0123][0-9]\.[01][0-9]\.[1290]{2}[0-9]{2})([,+:#\\.x][0-9]+|T[012][0-9]:*[0-5][0-9]:*[0-5][0-9](\\+[0-9]{2}:*[0-9]{2}|Z|UTC)*|[\t ]+[012]*[0-9].[0-5][0-9](-[0-9]{1,2}.[0-5][0-9])*)*\\b"
