...
#define IS_NODE_PIE_IGNORE_TAGS(N) (N == NULL || IS_NODE(N,NAME_PIE_META) || IS_NODE(N,NAME_PIE_PRE) || IS_NODE(N,NAME_PIE_TT) || IS_NODE(N,NAME_PIE_DATE) || IS_NODE(N,NAME_PIE_LINK))
