...
valgrind --leak-check=full --show-error-list=yes --show-reachable=yes --show-leak-kinds=all --fullpath-after= --num-callers=20  --log-file=$TMP/cxproc-cgi-valgrind.log $DIR_PREFIX/www/cgi-bin/cxproc-cgi 1> $TMP/cxproc-cgi.bin 2> $TMP/cxproc-cgi.err
