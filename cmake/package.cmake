...
IF (CXPROC_ARCHIVE)
  list(APPEND CPACK_DEBIAN_PACKAGE_DEPENDS "libarchive")
ENDIF (CXPROC_ARCHIVE)

IF (CXPROC_MARKDOWN)
  list(APPEND CPACK_DEBIAN_PACKAGE_DEPENDS "libcmark")
ENDIF (CXPROC_MARKDOWN)

IF (CXPROC_LIBEXIF)
  list(APPEND CPACK_DEBIAN_PACKAGE_DEPENDS "libexif")
ENDIF (CXPROC_LIBEXIF)

IF (CXPROC_LIBMAGICK)
  list(APPEND CPACK_DEBIAN_PACKAGE_DEPENDS "libmagick")
